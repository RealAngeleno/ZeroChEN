...
sub PrintReadFoot
{
	...
	# Display Menu
	$Page->Print("<a href=\"#top\" accesskey=\"2\">First</a>");
	$Page->Print("<a href=\"$pathPrev\" accesskey=\"4\">Previous</a>");
	$Page->Print("<a href=\"$pathNext\" accesskey=\"6\">Next</a>");
	$Page->Print("<a href=\"$pathLast?guid=ON\" accesskey=\"3\">Last</a>");
	$Page->Print("<a href=\"$pathAll\" accesskey=\"1\">1-</a>");
	$Page->Print("<a href=\"$pathBBS\" accesskey=\"5\">Board</a>");
