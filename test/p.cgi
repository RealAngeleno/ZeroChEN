...
sub PrintHead
{
	...
	if ($Sys->Get('PATHKIND')) {
		$Page->Print("<a href=\"$path?bbs=$bbs&st=$st\">Previous</a> ");
		$Page->Print("<a href=\"$path?bbs=$bbs&st=$last\">Next</a><br>\n");
	}
	else {
		$Page->Print("<a href=\"$path/$bbs/$st\">Previous</a> ");
		$Page->Print("<a href=\"$path/$bbs/$last\">Next</a><br>\n");
	}
	$Page->Print("<input type=hidden name=method value=search>");
	$Page->Print("<input type=text name=word><input type=submit value=\"Search\"><hr>");
}
...
sub PrintFoot
{
	...
	if ($Sys->Get('PATHKIND')) {
		$Page->Print("<hr><a href=\"$path?bbs=$bbs&st=$st\">Previous</a> ");
		$Page->Print("<a href=\"$path?bbs=$bbs&st=$last\">Next</a><br>\n");
	}
	else {
		$Page->Print("<hr><a href=\"$path/$bbs/$st\">Previous</a> ");
		$Page->Print("<a href=\"$path/$bbs/$last\">Next</a><br>\n");
	}
